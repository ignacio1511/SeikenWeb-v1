        ...
        <>
            <section className="sticky justify-center items-center">
                ...
                <div className='absolute lg:pt-20 mt-10 pt-3 lg:mt-20 inset-0 justify-center items-center mx-10'>
                    ...
                    <button type="submit" class="mt-4 mx-10 justify-center btn btn-primary bg-orange-700" name="action" valu="submit" data-toggle="button" aria-pressed="false" autocomplete="off">Descarga la rutina GRATIS</button>K                </div>
            </section>
        </>
